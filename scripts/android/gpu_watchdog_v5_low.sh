...
# CORRECTED 2026-08-08: this header was copied verbatim from the v5HIGH script and
# described thresholds this file does not use. The code below is the EARLY-trigger
# ladder; the numbers now match it.
# battery: <36 full ; >=36.0/36.5/37.0/37.5/38.0 -> tier 1/2/3/4/4
# skin   : <39.5 full ; >=39.5/40.0/40.5/41.0/41.5 -> tier 1/2/3/4/4
bat_tier(){ b=$1
  if   [ $b -ge 38000 ]; then echo 4; elif [ $b -ge 37500 ]; then echo 4
  elif [ $b -ge 37000 ]; then echo 3; elif [ $b -ge 36500 ]; then echo 2
  elif [ $b -ge 36000 ]; then echo 1; else echo 0; fi; }
skin_tier(){ s=$1
  if   [ $s -ge 41500 ]; then echo 4; elif [ $s -ge 41000 ]; then echo 4
  elif [ $s -ge 40500 ]; then echo 3; elif [ $s -ge 40000 ]; then echo 2
  elif [ $s -ge 39500 ]; then echo 1; else echo 0; fi; }
...
echo "$(date) gpu-wd v5LOW early-trigger: bat_z=$BATZ skin_z=$SKINZ gpuss=($GZONES) anchors bat36/skin39.5 backstop98" > "$LOG"
