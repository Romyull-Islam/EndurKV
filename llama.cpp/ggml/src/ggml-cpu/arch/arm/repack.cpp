...
void ggml_gemv_q1_0_4x4_q8_0(int                        n,
    ...
    for (int c = 0; c < nc; c += ncols_interleaved) {
        ...
        for (int l = 0; l < nb; l++) {
            const float32x4_t b_d = vcvt_f32_f16(vld1_f16((const __fp16 *) b_ptr[l].d));
...
void ggml_gemm_q1_0_4x4_q8_0(int                        n,
    ...
    for (int y = 0; y < nr / 4; y++) {
        ...
        for (int x = 0; x < nc / ncols_interleaved; x++) {
            ...
            for (int l = 0; l < nb; l++) {
                float32x4_t b_d = vcvt_f32_f16(vld1_f16((const __fp16 *) b_ptr[l].d));
                ...
                for (int k = 0; k < 4; ++k) {
                    ...
                    float32x4_t a_d = vcvt_f32_f16(vld1_f16((const __fp16 *) a_blk->d));
        ...
        for (int x = 0; x < nc / ncols_interleaved; x++) {
            ...
            for (int l = 0; l < nb; l++) {
                ...
                for (int k = 0; k < 4; ++k) {
                    ...
                    const float32x4_t a_d = vcvt_f32_f16(vld1_f16((const __fp16 *) a_blk->d));
