...
\begin{table*}[tp]
\caption{Sustained decode on the CPU, cold start, charging off. Llama and Bonsai: 9737-token prompt, 4096 generated, all at $K{=}1024$. Phi-3 and gemma: 7542 and 6382 tokens, 2048 generated, own budgets. Cells live after prefill.}
\label{tab:cpu}
...
\begin{table}[tb]
\caption{Adreno 840, 12K-token prompt plus 4096 generated tokens, f16 KV throughout, cold start, median of $n$ runs. Cells retained after prefill. Phi-3 rows use the current build and its driver gate.}
\label{tab:gpu}
\centering\footnotesize
