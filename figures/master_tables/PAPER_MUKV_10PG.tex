...
\caption{The energy-aware control plane, once per request, lettered A to F so the stages never collide with the numbered components of Figure~\ref{fig:architecture}. Stage D is that figures steps 1 to 3. The thermal guard acts on the clock beside it.}
