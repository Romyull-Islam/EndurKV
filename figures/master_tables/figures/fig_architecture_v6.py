...
box(62, y0, 12, h0, 'Evict + compact', 'seq-level ·\nin-place slide', ec=ORANGE, fc=ORANGEF, fsub=5.2, sdy=-3.8)
...
ax.add_patch(FancyBboxPatch((80.2, 72.8), 14.6, 4, boxstyle='round,pad=0.25,rounding_size=0.8',
                            fc=ORANGEF, ec=ORANGE, lw=0.9, zorder=5))
ax.text(87.5, 74.8, 'keep-set frozen · window slides', ha='center', va='center', fontsize=4.6, color=INK, zorder=6)
...
ax.text(69.3, 63.5, 'slide in place (4.8 ms)', fontsize=5.2, ha='left', va='center', color=ORANGE)
...
box(42, yb, 20, hb, 'Watchdog', 'graduated glide: 0.5°C steps\n1497→1017 MHz, anchored\nat the measured cliff', ec=ORANGE, fc=ORANGEF,
    fsub=4.8, sdy=-3.8)
...
ax.text(68, 25.6, 'step down early,', fontsize=5.0, ha='center', va='center', color=ORANGE)
ax.text(68, 23.2, 'debounced restore', fontsize=5.0, ha='center', va='center', color=ORANGE)
...
fig.tight_layout()
out = '/home/mislam22/EndurKV_workspace/EndurKV/figures/master_tables/figures/fig_architecture_v6'
