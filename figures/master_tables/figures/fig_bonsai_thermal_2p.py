...
fig, ax = plt.subplots(2, 1, figsize=(3.4, 2.75), sharex=True)
...
ax[1].set_ylabel("battery\n(°C)"); ax[1].set_ylim(32, 53); ax[1].set_xlabel("elapsed time (min)")
...
fig.savefig("figures/fig_bonsai_thermal_2p.png", dpi=200, bbox_inches="tight")
fig.savefig("figures/fig_bonsai_thermal_2p.pdf", bbox_inches="tight")
