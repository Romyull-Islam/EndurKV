...
\node[draw=or,fill=orf,minimum width=0.45cm,minimum height=0.22cm,inner sep=0] at (10.0,3.55) {};\node[lab,anchor=west] at (10.3,3.55) {$\mu$KV mechanism};
\node[draw=gr,fill=grf,minimum width=0.45cm,minimum height=0.22cm,inner sep=0] at (12.9,3.55) {};\node[lab,anchor=west] at (13.2,3.55) {unmodified};
\node[draw=gn,fill=gnf,minimum width=0.45cm,minimum height=0.22cm,inner sep=0] at (15.15,3.55) {};\node[lab,anchor=west] at (15.45,3.55) {outcome};
% ================= the pass =================
