...
\tikzset{colA/.style={box,minimum width=4.0cm,text width=3.8cm,minimum height=0.8cm},
         colA2/.style={colA,draw=or,fill=orf,line width=0.8pt,minimum height=1.35cm},
...
\node[colA2] (wd)    at (2.35,1.05)  {\bx{Watchdog}{CPU 1497 to 1017\,MHz, both clusters,\\ lower of the battery and skin ladders\\ GPU 1050 to 902\,MHz on DDR\\ vendor limiter applied last}};
