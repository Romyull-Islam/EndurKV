...
\node[inner sep=0,anchor=west] (heat) at (4.7,9.4) {\includegraphics[width=3.4cm,height=0.8cm]{heat.pdf}};
...
\node[head,anchor=north] at (6.5,2.2) {union across heads {\mdseries\scriptsize (4 of 32 shown)}};
\draw[flow] (keep.south) -- (2.05,2.25);
\input{mech_grids.tex}
...
\node[lab] at (2.75,0.7) {$\to$}; \node[lab,anchor=north] at (6.5,0.55) {union of 32 heads: 13 of 16 bins live};
\node[lab,text=gn,anchor=north] at (2.05,0.45) {compacted: same positions in every layer};
