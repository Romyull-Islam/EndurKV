...
\node[stepg] at (sense.north west) {1};\node[stepn] at (decide.north west) {2};\node[stepn] at (act.north west) {3};
\node[stepg] at (run.north west) {4};\node[stepn] at (measure.north west) {5};
...
\node[stepn] at (learn.north west) {6};
