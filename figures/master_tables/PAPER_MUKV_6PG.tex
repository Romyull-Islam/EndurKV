...
\begin{table}[tb]
\caption{Quality, both benchmarks measured on the phone. Needle: hits out of 14 depths per model, and the mean live cache after prefill. LongBench: Llama-3.2-1B on the CPU, 103 prompts, each policy at its own published budget.}
\label{tab:quality}
\centering\scriptsize
